...
function CharactersPage() {
    ...
    return (
        <section>
            ...
            {!isLoading && !errorMessage && characters.length === 0 && ( <p>No characters found.</p> )}
            ...
            {characters.length > 0 && (
                <div className="pagination">
                    <button onClick={goToPreviousPage} disabled={isLoading || currentPage === 1}>
                        Previous
                    </button>
                    <span>
                        Page {currentPage} of {totalPages}
                    </span>
                    <button onClick={goToNextPage} disabled={isLoading || currentPage >= totalPages}>
                        Next
                    </button>
                </div>
            )}
